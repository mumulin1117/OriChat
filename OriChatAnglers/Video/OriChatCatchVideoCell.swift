...
final class OriChatCatchVideoCell: UICollectionViewCell, UIGestureRecognizerDelegate {
    ...
    func configure(with item: OriChatCatchVideo) {
        coverView.setImageURL(item.videoCoverURL, placeholderColor: UIColor(white: 0.12, alpha: 1))
        avatarView.setImageURL(item.userAvatarURL, placeholderColor: UIColor(white: 0.20, alpha: 1))
