...
final class OriChatBuddyDetailController: UIViewController {
    ...
    private func hero() -> UIView {
        ...
        let image = UIImageView(image: AppAsset.buddyImage(named: trip.coverAssetName, fallback: AppAsset.buddyCoverDockMorning))
    ...
    private func organizerCard() -> UIView {
        let card = cardView()
        let avatar = UIImageView(image: AppAsset.buddyImage(named: trip.organizer.avatarAssetName, fallback: AppAsset.buddyAvatarGuest01))
    ...
    private func attendee(name: String, asset: String, host: Bool) -> UIView {
        let image = UIImageView(image: AppAsset.buddyImage(named: asset, fallback: AppAsset.buddyAvatarGuest01))
