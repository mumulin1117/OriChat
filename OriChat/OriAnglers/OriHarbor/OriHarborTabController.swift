...
final class MainTabBarController: UITabBarController {
    ...
    private func configureTabBar() {
        let home = wrap(HomeViewController(), title: "Home", idle: "oriangler_tab_home_idle", active: "oriangler_tab_home_active")
        let community = wrap(CommunityViewController(), title: "Buddy", idle: "oriangler_tab_buddy_idle", active: "oriangler_tab_buddy_active")
        let video = wrap(VideoViewController(), title: "Video", idle: "oriangler_tab_video_idle", active: "oriangler_tab_video_active")
        let profile = wrap(ProfileViewController(authStore: authStore), title: "Profile", idle: "oriangler_tab_profile_idle", active: "oriangler_tab_profile_active")
